sap.ui.define([
    ...
    function (Controller, MessageToast) {
        ...
        return Controller.extend("day5exercise1.controller.MainView", {
            onSend: function (oEvent) {
                ...
                console.log(sAge);
                console.log(oTech);
                MessageToast.show("Your name is " + sName + ", your surname is " + sSurname + ", your age is " + sAge + ", your tech is " + oTech);
            }
        });
    });