		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#day5exercise1giga-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"day5exercise1giga-display": {
								"semanticObject": "day5exercise1giga",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=day5exercise1giga",
									"url": sap.ui.require.toUrl("day5exercise1giga")
								}
							}
						}
					}
